...
# include("/Users/shaox0a/Desktop/GNN_nonstat/Codes/sitewise/GNN_functions.jl")
...
train_parameters = prior(
    K_train, fixed_locs, surface_sampler;
    gridded = gridded,
    n_range = 200:300,
    λ_range = (10.0, 50.0),
    graph_k = graph_k,
...
size(train_parameters.g[1].edata.e)

# =========================================================

# outputs
S = train_parameters.S[1]            
...
figg = plot_graph(train_parameters.g[1]; title = "fixed irregular graph")
display(figg)

fig_local = plot_node_neighborhood(train_parameters.g[1], 2)
display(fig_local)
...
figg = plot_graph(train_parameters.g[2]; title = "fixed irregular graph")
...
figg = plot_graph(val_parameters.g[1]; title = "fixed irregular graph")
...
# # ---------------------------------- NBE-GNN
# include("/Users/shaox0a/Desktop/GNN_nonstat/Codes/sitewise/model-NBEGNN_irr.jl")

# model = make_nodewise_spatial_gnn(
#     hidden = 64,
#     d_max = 0.25f0,
#     Kd = 8,
#     Kp = 16,
...
#     X_val, Y_val;
#     loss_fn = node_loss,
#     dataset_loss_fn = node_dataset_loss,
#     epochs = 60,
#     lr = 1e-4,
#     λ_smooth = 1f-4,
#     seed = 1234,
...
results_dir = "/Users/shaox0a/Desktop/GNN_nonstat/Codes/sitewise/results/irregular_data"
mkpath(results_dir)

model_path = joinpath(results_dir, "SGCN_v3.bson")
...
for test_seed in 1:10
    ...
    fig_path = joinpath(results_dir, "test$(test_seed).png")
    save(fig_path, fig)
